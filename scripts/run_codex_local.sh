...
LOCAL_CONTEXT_WINDOW="${LOCAL_DFLASH_CODEX_CONTEXT_WINDOW:-98304}"
LOCAL_AUTO_COMPACT_LIMIT="${LOCAL_DFLASH_CODEX_AUTO_COMPACT_LIMIT:-80000}"
LOCAL_MAX_OUTPUT_TOKENS="${LOCAL_DFLASH_CODEX_MAX_OUTPUT_TOKENS:-32768}"
...
LOCAL_TOOL_OUTPUT_LIMIT="${LOCAL_DFLASH_CODEX_TOOL_OUTPUT_LIMIT:-64000}"
