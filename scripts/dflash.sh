...
apply_profile_114() {
  ...
  export LOCAL_DFLASH_ENGINE=ddtree
  export LOCAL_DFLASH_DDTREE_TREE_BUDGET=8
  export LOCAL_DFLASH_DDTREE_APPROX_LOGPROBS=1
  export LOCAL_DFLASH_DDTREE_TARGET_TURBOQUANT_BITS=0
