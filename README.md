...
export LOCAL_DFLASH_DEFAULT_TOP_P=0.8
export LOCAL_DFLASH_DEFAULT_TOP_K=20
export LOCAL_DFLASH_DEFAULT_MIN_P=0
...
export LOCAL_DFLASH_MLX_MEMORY_LIMIT_GB=76
export LOCAL_DFLASH_MLX_CACHE_LIMIT_GB=6
export LOCAL_DFLASH_MLX_WIRED_LIMIT_GB=76
export LOCAL_DFLASH_MLX_CLEAR_CACHE_THRESHOLD=0.75
export LOCAL_DFLASH_NO_PRELOAD=0
export LOCAL_DFLASH_RESPONSE_HISTORY_LIMIT=8
export LOCAL_DFLASH_PREFIX_CACHE_STATE_LIMIT=1
export LOCAL_DFLASH_GLOBAL_PREFIX_CACHE_LIMIT=2
export LOCAL_DFLASH_GLOBAL_PREFIX_CACHE_BYTE_LIMIT_GB=6
